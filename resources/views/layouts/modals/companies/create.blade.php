<div class="modal fade" id="createCompany" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                    ...
                    <div class="form-group">
                        <div class="text-center mb-3">
                            ...
                            <input type="file" class="form-control" id="logo" name="logo"
                                accept="image/x-png, image/png, image/jpg, image/jpeg" required>
                        </div>
